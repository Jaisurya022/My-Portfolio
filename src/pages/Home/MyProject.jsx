    ...
    <section className="project--section" id="MyProject">
      <div className="project--container-box">
        <div className="project--container">
          ...
          <h2 className="section--heading">E-commerce website</h2>
        </div>
        <div>
          <a href="https://github.com/Jaisurya022/React-Js-Project.git">
      ...
      <div className="project--section--container">
        {data?.project?.map((item, index) => (
          <div key={index} className="pproject--section--card">
